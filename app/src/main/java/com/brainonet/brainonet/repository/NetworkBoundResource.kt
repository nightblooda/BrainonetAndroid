package com.brainonet.brainonet.repository
...
import com.brainonet.brainonet.util.Constants.Companion.NETWORK_TIMEOUT
import com.brainonet.brainonet.util.Constants.Companion.TESTING_CACHE_DELAY
import com.brainonet.brainonet.util.Constants.Companion.TESTING_NETWORK_DELAY
import com.brainonet.brainonet.util.ErrorHandling.Companion.ERROR_CHECK_NETWORK_CONNECTION
...
abstract class NetworkBoundResource<ResponseObject, CacheObject, ViewStateType>
    ...
    shouldCancelIfNoInternet: Boolean, // should this job be cancelled if there is no network connection
    shouldLoadFromCache: Boolean // should load data from cache
) {
        ...
        if(isNetworkRequest){
            ...
            if(isNetworkAvailable){
                ...
                if(shouldCancelIfNoInternet){
                    onErrorReturn(ErrorHandling.UNABLE_TODO_OPERATION_WO_INTERNET,
